...
class User(AbstractBaseUser,PermissionsMixin):
    ...
    PO_name = models.CharField(verbose_name=_("PO name"),unique=True,max_length=15)
    address = models.CharField(verbose_name=_("가게 주소"),unique=True,max_length=100) 
    collector = models.CharField(verbose_name=_("수집자 이름"),unique=True,max_length=15) 
